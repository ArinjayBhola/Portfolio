...
export function VisitorTrafficChart({
  ...
  return (
    <div className="lg:col-span-8 bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-200 shadow-sm">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
        ...
        <div className="flex items-center bg-slate-50 p-1 rounded-2xl border border-slate-200 self-start">
      ...
      <div className="h-[300px] md:h-[320px] w-full flex items-center justify-center relative">
        {hasVisitors ? (
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData}>
              ...
              <Tooltip 
                ...
                itemStyle={{ color: '#4f46e5', fontWeight: 600, fontSize: '14px' }}
          ...
          <div className="flex flex-col items-center gap-4 opacity-20">
            <div className="w-16 h-16 rounded-full border-2 border-dashed border-indigo-200 flex items-center justify-center">
              <TrendingUp className="w-8 h-8 text-indigo-400" />
            </div>
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-slate-500">No traffic data recorded</p>
          </div>
        )}
      </div>
    </div>
